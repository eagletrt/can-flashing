...
typedef enum {
  ...
  FLASH_TYPE_ACQUISINATOR_6,
  FLASH_TYPE_ACQUISINATOR_7,
  FLASH_TYPE_ACQUISINATOR_8,
  FLASH_TYPE_ACQUISINATOR_9,
  FLASH_TYPE_ACQUISINATOR_10,
  FLASH_TYPE_ACQUISINATOR_11,
  FLASH_TYPE_ACQUISINATOR_12,
  FLASH_TYPE_ACQUISINATOR_13,
  FLASH_TYPE_ACQUISINATOR_14,
  FLASH_TYPE_ACQUISINATOR_15,
  FLASH_TYPE_ACQUISINATOR_16,
  FLASH_TYPE_ACQUISINATOR_17,
  FLASH_TYPE_ACQUISINATOR_18,
  FLASH_TYPE_ACQUISINATOR_19,
  FLASH_TYPE_ACQUISINATOR_20,
  FLASH_TYPE_ACQUISINATOR_21,
  FLASH_TYPE_ACQUISINATOR_22,
  FLASH_TYPE_ACQUISINATOR_23,
  FLASH_TYPE_ACQUISINATOR_24,
  FLASH_TYPE_ACQUISINATOR_25,
  FLASH_TYPE_ACQUISINATOR_26,
  FLASH_TYPE_ACQUISINATOR_27,
  FLASH_TYPE_ACQUISINATOR_28,
  FLASH_TYPE_ACQUISINATOR_29,
  FLASH_TYPE_ACQUISINATOR_30,
  FLASH_TYPE_ACQUISINATOR_31,
  FLASH_TYPE_COUNT
}FLASH_TYPE;
